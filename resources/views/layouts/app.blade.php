    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="{{route('coursedetail', 1)}}">Courses</a></li>
      ...
      <a href="{{route('course')}}" class="get-started-btn">Get Started</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{route('coursedetail',1)}}">Course Details</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{route('trainer')}}">Trainers</a></li>
