...
<body>
  ...
  <section id="container" class="" style="margin-top: -65px;">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="{{ asset('storage/uploads/a.png') }}" alt="upload-image">
                            </span>
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li class="eborder-top">
                <a href="{{ route('profile', Crypt::encrypt(Auth::user()->id)) }}"><i class="icon_profile"></i> My Profile</a>
              </li>
              <li>
                <a href="{{ route('changepass', Crypt::encrypt(Auth::user()->id)) }}"><i class="icon_profile"></i> Change Password</a>
              </li>
              <li>
              ...
              <li>
                <a href="#"><i class="icon_chat_alt"></i> Message</a>
              </li>
              <li>
              ...
              <li>
                <a href="documentation.html"><i class="icon_key_alt"></i> Your Task</a>
              </li>
              <li>
                <a href="documentation.html"><i class="icon_key_alt"></i> Your Result</a>
              </li>
            </ul>
          </li>
...
<!--        <div class="row">
  ...
  <script src="assets/vendor1/waypoints/noframework.waypoints.js"></script>
